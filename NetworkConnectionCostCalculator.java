// QN.3a - NetworkConnectionCostCalculator
 ...
 */
 ...
 public class NetworkConnectionCostCalculator { // Class to compute the minimum cost to connect all devices in a network
     ...
     public static int calculateMinimumConnectionCost(int n, int[] moduleCosts, int[][] connections) {
         ...
         int minModuleCost = Arrays.stream(moduleCosts).min().getAsInt();
     ...
     public static void main(String[] args) {
         ...
         int[] moduleCosts = {1, 2, 2}; // Cost of the module for each device
         int[][] connections = {{1, 2, 1}, {2, 3, 1}}; // Available connections (device1, device2, cost)
 
         // Compute and display the minimum connection cost
         int result = calculateMinimumConnectionCost(n, moduleCosts, connections);
         System.out.println("Minimum total connection cost for the network: " + result); // Expected output: 3
     }
 }
 
 // Output: Minimum total connection cost for the network: 3
